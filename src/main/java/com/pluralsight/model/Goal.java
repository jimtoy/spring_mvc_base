...
@Table(name = "goals")
@NamedQueries({
        @NamedQuery(name = Goal.FIND_GOAL_REPORTS, query = "select new com.pluralsight.model.GoalReport(g.minutes, e.minutes, e.activity) from Goal g, Exercise  e where g.id = e.id"),
